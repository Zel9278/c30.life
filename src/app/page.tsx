  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:description" content="c30のホームページです。" />
        <meta property="og:image" content="https://c30.life/c30_rounded.png" />
      ...
      <main>
        <div className="text-center text-2xl">
          ...
          <p className="text-sm">あなたは今、{counter}個目のポットです。</p>
            ...
            <div className="card w-auto bg-base-300 shadow-xl m-5">
              <div className="card-body items-center text-center">
                ...
                <div className="flex">
                  ...
                  <div className="border-2 border-stone-800 border-opacity-25 text-center rounded p-2">
                    <p className="text-sm text-stone-400">生地</p>
                    <p>Misskey</p>
                ...
                <div id="hobby-badges">
                  <div className="badge bg-zinc-900">イラストレーション</div>
                  <div className="badge bg-zinc-900">曲制作・耳コピ</div>
                  <div className="badge bg-zinc-900">プログラミング</div>
                  <div className="badge bg-zinc-900">Misskey</div>
                </div>
